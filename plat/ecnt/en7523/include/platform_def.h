...
#define IO_BLOCK_BUF_OFFSET		(EN7523_MEM_BASE + UL(0x1800000))
#define IO_BLOCK_BUF_SIZE		UL(0x40000)
#define MAX_IO_BLOCK_DEVICES		32
#endif
#ifndef OVERRIDE_PLAT_ECNT_BL31_FIP_OFFSET
#define PLAT_ECNT_BL31_FIP_OFFSET	(0x20000)
#else
#define PLAT_ECNT_BL31_FIP_OFFSET	OVERRIDE_PLAT_ECNT_BL31_FIP_OFFSET
#endif
#if defined(IMAGE_BL1)
