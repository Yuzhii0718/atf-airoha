...
#ifndef __ECNT_SPI_NAND_FLASH_H__
#define __ECNT_SPI_NAND_FLASH_H__
...
#define _SPI_NAND_DEVICE_ID_MXIC35LF4GE4AD  0x37
...
typedef u8 SPI_NAND_FLASH_READ_DUMMY_BYTE_T;
...
typedef u8 SPI_NAND_FLASH_READ_SPEED_MODE_T;
...
typedef u8 SPI_NAND_FLASH_WRITE_SPEED_MODE_T;

enum {
	SPI_NAND_FLASH_WRITE_LOAD_FIRST =0,
	SPI_NAND_FLASH_WRITE_EN_FIRST,
};
typedef u8 SPI_NAND_FLASH_WRITE_EN_TYPE_T;
...
#endif /* ifndef __ECNT_SPI_NAND_FLASH_H__ */
